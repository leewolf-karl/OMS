		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">	
                <ul class="nav navbar-nav side-nav3">	
					...
					<?php
						...
						{
							echo "
							<a href='transactions/clientportal/cagreement.php' id = 'style'><i class='fa fa-fw fa-bar-chart-o'></i> Client Agreement <text class = clientext style = 'color: red; margin-left: 5px;'></text></a>";
						}
						else
						{
							echo "
					...
					<li>
						<a href="transactions/clientportal/joborder.php" id = "style"><i class="fa fa-fw fa-bar-chart-o"></i> Send Job Order</a>
					</li>
					<li>
						<a href="transactions/clientportal/shortlist.php" id = "style"><i class="fa fa-fw fa-bar-chart-o"></i> Shortlist</a>
					</li>	
					<li>
						<a href="transactions/clientportal/deployed.php" id = "style"><i class="fa fa-fw fa-bar-chart-o"></i> Deployed Staff</a>
					</li>		
					<li>
                        <a id = "style"><i class="fa fa-fw fa-bar-chart-o"></i> MANAGE STAFF <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul>
                            <li>
                                <a class = "styles" href="transactions/clientportal/stafflist.php">Staff List</a>
                            </li>
                            <li>
                                <a class = "styles" href="transactions/clientportal/time.php">Time and Attendance</a>
                            </li>
                            <li>
                                <a class = "styles" href="transactions/clientportal/reshuffle.php">Reshuffle</a>
                            </li>
                            <li>
                                <a class = "styles" href="transactions/clientportal/replace.php">Replace</a>
                            </li>
                        </ul>
                    </li>
                </ul>
