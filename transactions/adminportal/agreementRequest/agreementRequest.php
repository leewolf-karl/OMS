	...
	?>
		...
		<div id="page-wrapper" class = "fright">
			<div class="container-fluid" id = "data">
				...
				<br><br>
				<text class = "tranhead"><center>CLIENT AGREEMENT REQUESTS</center></text><br>
				<select name = "for" class = "form-control clientext" style = "width: 20%; margin-bottom: 20px;	">
					<option class = "form-control" selected disabled>Filter Requests By</option>
					<option value = "0" class = "form-control">In Progress</option>
					<option value = "1" class = "form-control">Completed</option>
					<option value = "2" class = "form-control">Expired</option>
					<option value = "3" class = "form-control">Terminated</option>
					<option value = "4" class = "form-control">Rejected</option>
				</select>
				<br>
				<table id="example" class="table table-hovertransac table-bordered" cellspacing="0" width="100%">
					...
					<tbody>
						<?php
							...
							$sql = "select * from client order by ApplicationDate desc";
