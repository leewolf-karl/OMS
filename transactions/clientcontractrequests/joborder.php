...
<html lang="en">
	...
	<text class = "clientext" style = "float: left; margin-right: 3px;"><b>Job Information:</b></text><br><br>
						...
						<input type = "text" id = "minsal" class = "form-control" style = "float: left; width: 15%; height: 25px;" disabled>
						<text class = "clientext" style = "float: left; margin-left: 30px; margin-top: 5px; margin-left: 20px; margin-right:20px;">Maximum:</text>
						<input type = "text" id = "maxsal" class = "form-control" style = "width: 15%; height: 25px;" disabled><br><br>
						<text class = "clientext" style = "float: left; margin-right: 10px;"><b>Number of Openings: </b></text>
								...
								<text class = "clientext" style = "float: left;"><b>Skill:</b></text><br>
									<div class = "col-lg-12" id="skill">
	...
	<div class  = "col-lg-6 reqRight">
			<div class = "col-lg-12">
								...
								<text class = "clientext" style = ""><b>Requirements:</b></text><br>
									<div class = "col-lg-12" id="req">
									</div>
										
								
								<br><br>
								<text class = "clientext" style = "float: left;"><b>Benefits:</b></text><br>
									<div class = "col-lg-12" id="ben">
									</div>
								<br><br>
						...
						<button type="submit" name="order" class="btn btn-success">SEND</button>
					</div>
		...
		<script>
			...
			$("#job").change(function() {
	  		$("#qua").load("getqualist.php?j=" + $("#job").val());
			});
			
			$("#job").change(function() {
	  		$("#skill").load("getskilllist.php?j=" + $("#job").val());
			});
			
			$("#job").change(function() {
	  		$("#req").load("getrequirementslist.php?j=" + $("#job").val());
			});
			
			$("#job").change(function() {
	  		$("#ben").load("getbenefitslist.php?j=" + $("#job").val());
			});
