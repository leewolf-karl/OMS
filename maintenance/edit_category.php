...
<?php
    ...
    if($row >= 1){
        ...
        $query1 = mysql_query("Update `job_category` Set Name = '$catName' WHERE CategoryID = $catId;");
        ?>
          <div>
              <script>
                  $(function(){
                                        ...
                                        ?>
                                            <div>
                                                <script>
                                                  $(function(){
                                                      $(document).ready(function(){
                                                        $('input[name=edit_checkbox_<?php echo $catID;?>]').bootstrapSwitch('state', true, true);
                                                      });
                                                  });
                                                </script>
                                            </div>
...
<tr>
                                          ...
                                          <td>
                                             <center>
                                              ...
                                              ?>
                                              <?php 
                                                  echo "<input id='switch-state' name='edit_checkbox_$catID' type='checkbox' value='$catID' >";
                                              ?>
                                               <?php 
