...
<?php
    ...
    if($row >= 1){
       ...
       while($res = mysql_fetch_assoc($check)){
        ...
        $query1 = mysql_query("Update `qualification` Set Name = '$qualName' WHERE QualificationID = $qualId;");
        ?>
          <div>
              <script>
                  $(function(){
                                        ...
                                        ?>
                                            <div>
                                                <script>
                                                  $(function(){
                                                      $(document).ready(function(){
                                                        $('input[name=edit_checkbox_<?php echo $qualID;?>]').bootstrapSwitch('state', true, true);
                                                      });
                                                  });
                                                </script>
                                            </div>
...
<tr>
                                          ...
                                          <td>
                                             <center>
                                              ...
                                              ?>
                                              <?php 
                                                  echo "<input id='switch-state' name='edit_checkbox_$qualID' type='checkbox' value='$qualID' >";
                                              ?>
                                               <?php 
