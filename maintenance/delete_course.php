...
<?php
	...
	if (isset($_POST['id'])){
		...
		$query1 = mysql_query("Update `course` Set Status = 3 WHERE CourseID = $courseId;");
            if ($query1 == FALSE){
                                                ...
                                                <script>
                                                  $(function(){
                                                      $(document).ready(function(){
                                                        $('input[name=delete_checkbox_<?php echo $courseID;?>]').bootstrapSwitch('state', true, true);
                                                      });
                                                  });
                                                </script>
                                            </div>
...
<tr>
                                          ...
                                          <td>
                                             <center>
                                              ...
                                              ?>
                                              <?php 
                                                  echo "<input id='switch-state' name='delete_checkbox_$courseID' type='checkbox' value='$courseID' >";
                                              ?>
                                               <?php 
