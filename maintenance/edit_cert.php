...
<?php
    ...
    if($row >= 1){
        ...
        $query1 = mysql_query("Update `certification` Set Name = '$certName' WHERE CertificationID = $certId;");
        ?>
          <div>
              <script>
                  $(function(){
                                        ...
                                        ?>
                                            <div>
                                                <script>
                                                  $(function(){
                                                      $(document).ready(function(){
                                                        $('input[name=edit_checkbox_<?php echo $certID;?>]').bootstrapSwitch('state', true, true);
                                                      });
                                                  });
                                                </script>
                                            </div>
...
<tr>
                                          ...
                                          <td>
                                             <center>
                                              ...
                                              ?>
                                              <?php 
                                                  echo "<input id='switch-state' name='edit_checkbox_$certID' type='checkbox' value='$certID' >";
                                              ?>
                                               <?php 
