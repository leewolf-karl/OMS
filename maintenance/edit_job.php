...
<?php
    ...
    if($row >= 1){
       ...
       while($res = mysql_fetch_assoc($check)){
        ...
        $query1 = mysql_query("Update `job_title` Set Name = '$jobName', CategoryID = $catId, Service_fee = $jobSf, Min_Salary = $jobminSalary, Max_Salary = $jobmaxSalary, Cola = $jobCola WHERE JobID = $jobId;");
                                        ...
                                        ?>
                                            <div>
                                                <script>
                                                  $(function(){
                                                      $(document).ready(function(){
                                                        $('input[name=edit_checkbox_<?php echo $jobID;?>]').bootstrapSwitch('state', true, true);
                                                      });
                                                  });
                                                </script>
                                            </div>
...
<tr>
                                          ...
                                          <td>
                                             <center>
                                              ...
                                              ?>
                                              <?php 
                                                  echo "<input id='switch-state' name='edit_checkbox_$jobID' type='checkbox' value='$jobID' >";
                                              ?>
                                               <?php 
