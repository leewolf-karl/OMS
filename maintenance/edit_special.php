...
<?php
	...
	if(isset($_POST['id'])){
		...
		$speId = mysql_real_escape_string($_POST['id']);
    ...
    if($row >= 1){
        ...
        $query1 = mysql_query("Update `specialization` Set Name = '$speName' WHERE SpecializationID = $speId;");
        ?>
          <div>
              <script>
                  $(function(){
		...
		$query2 = mysql_query("SELECT * from specialization where Status != 3");
                                    if ($query2 == FALSE){
                                        ...
                                        ?>
                                            <div>
                                                <script>
                                                  $(function(){
                                                      $(document).ready(function(){
                                                        $('input[name=edit_checkbox_<?php echo $speID;?>]').bootstrapSwitch('state', true, true);
                                                      });
                                                  });
                                                </script>
                                            </div>
...
<tr>
                                          ...
                                          <td>
                                             <center>
                                              ...
                                              ?>
                                              <?php 
                                                  echo "<input id='switch-state' name='edit_checkbox_$speID' type='checkbox' value='$speID' >";
                                              ?>
                                               <?php 
