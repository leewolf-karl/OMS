...
<?php
	...
	if (isset($_POST['id'])){
		...
		$query1 = mysql_query("Update `leave` Set Status = 3 WHERE LeaveID = $leaveId;");
            if ($query1 == FALSE){
                                                ...
                                                <script>
                                                  $(function(){
                                                      $(document).ready(function(){
                                                        $('input[name=delete_checkbox_<?php echo $leaveID;?>]').bootstrapSwitch('state', true, true);
                                                      });
                                                  });
                                                </script>
                                            </div>
...
<tr>
                                          ...
                                          <td>
                                             <center>
                                              ...
                                              ?>
                                              <?php 
                                                  echo "<input id='switch-state' name='delete_checkbox_$leaveID' type='checkbox' value='$leaveID' >";
                                              ?>
                                               <?php 
