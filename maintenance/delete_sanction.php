...
<?php
	...
	if (isset($_POST['id'])){
		...
		$query1 = mysql_query("Update `sanction` Set Status = 3 WHERE SanctionID = $sancId;");
            if ($query1 == FALSE){
                                                ...
                                                <script>
                                                  $(function(){
                                                      $(document).ready(function(){
                                                        $('input[name=delete_checkbox_<?php echo $sanctionID;?>]').bootstrapSwitch('state', true, true);
                                                      });
                                                  });
                                                </script>
                                            </div>
...
<tr>
                                          ...
                                          <td>
                                             <center>
                                              ...
                                              ?>
                                              <?php 
                                                  echo "<input id='switch-state' name='delete_checkbox_$sanctionID' type='checkbox' value='$sanctionID' >";
                                              ?>
                                               <?php 
