...
<?php
	...
	if (isset($_POST['id'])){
		...
		$query1 = mysql_query("Update `skill` Set Status = 3 WHERE SkillID = $skillId;");
            if ($query1 == FALSE){
                                                ...
                                                <script>
                                                  $(function(){
                                                      $(document).ready(function(){
                                                        $('input[name=delete_checkbox_<?php echo $skillID;?>]').bootstrapSwitch('state', true, true);
                                                      });
                                                  });
                                                </script>
                                            </div>
...
<tr>
                                          ...
                                          <td>
                                             <center>
                                              ...
                                              ?>
                                              <?php 
                                                  echo "<input id='switch-state' name='delete_checkbox_$skillID' type='checkbox' value='$skillID' >";
                                              ?>
                                               <?php 
