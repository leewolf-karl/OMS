...
<?php
    ...
    if($row >= 1){
       while($res = mysql_fetch_assoc($check)){
        ...
        $query1 = mysql_query("Update `term_and_condition` Set Description = '$conDesc', Type = $conFor WHERE ConditionID = $conId;");
        ?>
          <div>
              <script>
                  $(function(){
                                        ...
                                        ?>
                                            <div>
                                                <script>
                                                  $(function(){
                                                      $(document).ready(function(){
                                                        $('input[name=edit_checkbox_<?php echo $conID;?>]').bootstrapSwitch('state', true, true);
                                                      });
                                                  });
                                                </script>
                                            </div>
...
<tr>
                                          ...
                                          <td>
                                             <center>
                                              ...
                                              ?>
                                              <?php 
                                                  echo "<input id='switch-state' name='edit_checkbox_$conID' type='checkbox' value='$conID' >";
                                              ?>
                                               <?php 
