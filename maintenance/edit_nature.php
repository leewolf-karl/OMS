...
<?php
    ...
    if($row >= 1){
       ...
       while($res = mysql_fetch_assoc($check)){
        ...
        $query1 = mysql_query("Update `business_nature` Set Name = '$natureDesc' WHERE BusinessNatureID = $natureId;");
                                        ...
                                        ?>
                                            <div>
                                                <script>
                                                  $(function(){
                                                      $(document).ready(function(){
                                                        $('input[name=edit_checkbox_<?php echo $natureID;?>]').bootstrapSwitch('state', true, true);
                                                      });
                                                  });
                                                </script>
                                            </div>
...
<tr>
                                          ...
                                          <td>
                                             <center>
                                              ...
                                              ?>
                                              <?php 
                                                  echo "<input id='switch-state' name='edit_checkbox_$natureID' type='checkbox' value='$natureID' >";
                                              ?>
                                               <?php 
