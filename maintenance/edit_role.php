...
<?php
	...
	if(isset($_POST['id'])){
		...
		$roleId = mysql_real_escape_string($_POST['id']);
    ...
    if($row >= 1){
        ...
        $query1 = mysql_query("Update `user_role` Set Name = '$roleName' WHERE RoleID = $roleId;");
        ?>
          <div>
              <script>
                  $(function(){
		...
		$query2 = mysql_query("SELECT * from user_role where Status != 3");
                                    if ($query2 == FALSE){
                                        ...
                                        ?>
                                            <div>
                                                <script>
                                                  $(function(){
                                                      $(document).ready(function(){
                                                        $('input[name=edit_checkbox_<?php echo $roleID;?>]').bootstrapSwitch('state', true, true);
                                                      });
                                                  });
                                                </script>
                                            </div>
...
<tr>
                                          ...
                                          <td>
                                             <center>
                                              ...
                                              ?>
                                              <?php 
                                                  echo "<input id='switch-state' name='edit_checkbox_$roleID' type='checkbox' value='$roleID' >";
                                              ?>
                                              <?php 
