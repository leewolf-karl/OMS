...
<head>
    ...
    <title>Admin | Educational Attainment</title>
    ...
    <script>
        ...
        $(function() {
              $('#table_educ').dataTable({
                ...
                $('#form_add_education').on("submit" , function(e){
                  var educName = $('#new_educ_name').val();

                        if(checker(educName, isAlphaNum) == false){
                            var dataString = "educname=" + educName;
        ...
        //insert edit ajax
                $('#form_edit_education').on("submit" , function(e){
                    var id = $('#changing_id').text();
                    var educName = $('#edit_educ_name').val();
               
                            if(checker(educName, isAlphaNum) == false){
                                  var dataString = "id=" + id + "&";
                                      dataString += "educname=" + educName;
              ...
              //delete ajax
              $('#form_delete_education').on("submit" , function(e){
              ...
              function ChangeEducation(educID){
                    $('#changing_id').text($('#changeid_' + educID).val());
                    $('#edit_educ_name').val($('#changename_' + educID).val());
                    $('#edit_education').modal('show');
              }

              function DeleteEducation(educID){
                    $('#delete_id').text($('#changeid_' + educID).val());
                    $('#delete_educ_name').text($('#changename_' + educID).val());
            ...
            <div class="row">
                <div class="col-lg-13">
                      <div class = "panel panel-primary" style='border-radius:0px;'>
                            <div class = "panel-heading" >
                              <div class = "slideanim slideright">
                                  <span class = "panel-title" style = "line-height:2;border-bottom-color:black;">
                                        <span style = "font-size:30px;" class = "slideanim slidetop" title = "Educational Attainment of Applicant">Manage Educational Attainment
                                        </span>
                                        <span style="position:relative;margin-left:2%;top:15px;font-size:15px;">*This page will let you to manage agency's acceptable Educational Background.
                                        </span> 
                                        <span class = "pull-right" style='position:relative;top:40px;'><a href = "#" data-toggle = "modal" data-target = "#add_education" class = "btn btn-raised btn-success"> <span class = "glyphicon glyphicon-plus"></span> Add New</a>                                        </span>
                                    </span>
                              </div>
                            </div>
                            ...
                            <div class = "panel-body" id = "educ_list">
                              <table class = "table table-hovered display" id = "table_educ">
                                  ...
                                  <tbody>
                                    <?php 
                                      ...
                                      $query = mysql_query("SELECT * from education where Status != 3");
                                          ...
                                          echo "<script>
                                                  $(function(){
                                                    $(document).ready(function(){
                                                      $('input[name=my_checkbox_$educID]').bootstrapSwitch('state', true, true);
                                                    })
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                             <center>
                                              ...
                                              ?>
                                              <?php 
                                                  echo "<input id='switch-state' name='my_checkbox_$educID' type='checkbox' value='$educID' >";
                                              ?>
                                               <?php 
...
<div id="delete_education" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
          <form class="form-horizontal" role="form" action = "" method = "POST" enctype="multipart/form-data" id = "form_delete_education">
                          ...
                          <div class="form-group" readonly>
                              <div class="col-xs-10">
                                  <font style="font-size:18px;">You are about to delete the following record on the list.<br>
                                    By clicking the delete button you will delete.. <br><br>Educational Attainment ID: <font style="color:red;margin-left:6%;"><span id ="delete_id"></span></font>
                                    <br>Educational Attainment Name: <font style="color:red;margin-left:1%;"><span id ="delete_educ_name"></span></font>
...
<div id="edit_education" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
    <div class="modal-content">
          <form class="form-horizontal" role="form" action = "" method = "POST" enctype="multipart/form-data" id = "form_edit_education">
               
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h2 class="modal-title">&nbsp; <span class="glyphicon glyphicon-edit" style="margin-right:10px;"></span>Edit Education</h2>
                    </div>
                    ...
                    <div style = "margin-left:10%;margin-bottom:10px;">
                        <br><br>
                          ...
                          <div class="form-group" readonly>
                              <div class="col-xs-10">
                                  <label for = "edit_ben_id">Educational Attainment ID: <span id ="changing_id"></span></label>
                              </div>
                          </div>

                          <div class="form-group">
                            <div class="col-xs-10">
                                <label for = "edit_educ_name">
                                  * Educational Attainment Name
                                </label>
                                <input type='text' maxlength='70' id = "edit_educ_name" class = "form-control" placeholder = "Enter Educational Attainment Name" required>
                            </div>
                          </div>
...
<div id="add_education" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
    <div class="modal-content">
          <form class="form-horizontal" role="form" action = "" method = "POST" enctype="multipart/form-data" id = "form_add_education">
               
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h2 class="modal-title">&nbsp; <span class="fa fa-fw fa-graduation-cap" style="margin-right:10px;"></span>Add New Education </h2>
                    </div>
                            ...
                            <br><br>
                                  ...
                                  <div class="col-xs-10">
                                      <label for = "new_spe_id" style='font-size:15px;'>
                                        Educational Attainment ID: 
                                          ...
                                          <?php
                                            $sql_in= mysql_query("Select * from education");
                              ...
                              <div class="form-group">
                                <div class="col-xs-10">
                                    ...
                                    <input type='text' maxlength='70' id = "new_educ_name" class = "form-control" placeholder = "Enter Educational Attainment Name" required>
                                </div>
                              </div>
