...
<?php
	...
	if (isset($_POST['id'])){
		...
		$query1 = mysql_query("Update `module` Set Status = 3 WHERE ModuleID = $modId;");
            if ($query1 == FALSE){
                                                ...
                                                <script>
                                                  $(function(){
                                                      $(document).ready(function(){
                                                        $('input[name=delete_checkbox_<?php echo $modID;?>]').bootstrapSwitch('state', true, true);
                                                      });
                                                  });
                                                </script>
                                            </div>
...
<tr>
                                          ...
                                          <td>
                                             <center>
                                              ...
                                              ?>
                                              <?php 
                                                  echo "<input id='switch-state' name='delete_checkbox_$modID' type='checkbox' value='$modID' >";
                                              ?>
                                               <?php 
