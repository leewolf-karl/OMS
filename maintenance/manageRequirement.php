    ...
    <script>
        ...
        $(function() {
              $('#table_requirement').dataTable({
                ...
                $('#form_add_req').on("submit" , function(e){

                  var reqName = $('#new_req_name').val();

                        if(checker(reqName, isAlphaNum) == false){
                            var dataString = "reqname=" + reqName;
        ...
        //insert edit ajax
                $('#form_edit_req').on("submit" , function(e){
                   
                    var id = $('#changing_id').text();
                    var reqName = $('#edit_req_name').val();
                  
                            if(checker(reqName, isAlphaNum) == false){
                                  var dataString = "id=" + id + "&";
                                      dataString += "reqname=" + reqName;
          ...
          //delete ajax
                $('#form_delete_req').on("submit" , function(e){
              ...
              function ChangeRequirement(reqID){

                    $('#changing_id').text($('#changeid_' + reqID).val());
                    $('#edit_req_name').val($('#changename_' + reqID).val());
                    $('#edit_req').modal('show');
              }

              function DeleteRequirement(reqID){
                
                    $('#delete_id').text($('#changeid_' + reqID).val());
                    $('#delete_req_name').text($('#changename_' + reqID).val());
            ...
            <div class="row">
                <div class="col-lg-13">
                      <div class = "panel panel-primary" style='border-radius:0px;'>
                            <div class = "panel-heading" >
                              <div class = "slideanim slideright">
                                  <span class = "panel-title" style = "line-height:2;border-bottom-color:black;">
                                        <span style = "font-size:30px;" class = "slideanim slidetop" title = "Things that need to be submitted by applicants and clients"> Manage Requirement
                                        </span>
                                        <span style="position:relative;margin-left:13%;top:15px;font-size:15px;">*This page will let you to manage agency's Requirement.
                                        </span> 
                                        <span class = "pull-right" style='position:relative;top:40px;'><a href = "#" data-toggle = "modal" data-target = "#add_req" class = "btn btn-raised btn-success"> <span class = "glyphicon glyphicon-plus"></span> Add New</a> 
                                        </span>
                                    </span>
                            ...
                            <div class = "panel-body" id = "req_list">
                              <table class = "table table-hovered display" id = "table_requirement">
                                  ...
                                  <tbody>
                                    <?php 
                                      ...
                                      $query = mysql_query("SELECT * from requirement where Status != 3");
                                          ...
                                          echo "<script>
                                                  $(function(){
                                                    $(document).ready(function(){
                                                      $('input[name=my_checkbox_$reqID]').bootstrapSwitch('state', true, true);
                                                    })
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                             <center>
                                              ...
                                              ?>
                                              <?php 
                                                  echo "<input id='switch-state' name='my_checkbox_$reqID' type='checkbox' value='$reqID' >";
                                              ?>
                                               <?php 
...
<div id="delete_req" class="modal fade" role="dialog">
  <div class="modal-dialog">

    <!-- Modal content-->
    <div class="modal-content">
          <form class="form-horizontal" role="form" action = "" method = "POST" enctype="multipart/form-data" id = "form_delete_req">
                          ...
                          <div class="form-group" readonly>
                              <div class="col-xs-10">
                                  <font style="font-size:18px;">You are about to delete the following record on the list.<br>
                                    By clicking the delete button you will delete.. <br><br>Requirement ID: <font style="color:red;margin-left:6%;"><span id ="delete_id"></span></font>
                                    <br>Requirement Name: <font style="color:red;margin-left:1%;"><span id ="delete_req_name"></span></font>
 ...
 <!-- edit department-->
<div id="edit_req" class="modal fade" role="dialog">
  <div class="modal-dialog">

    <!-- Modal content-->
    <div class="modal-content">
          <form class="form-horizontal" role="form" action = "" method = "POST" enctype="multipart/form-data" id = "form_edit_req">
               
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h2 class="modal-title">&nbsp; <span class="glyphicon glyphicon-edit" style="margin-right:10px;"></span>Edit Requirement </h2>
                    </div>
                    ...
                    <div style = "margin-left:10%;margin-bottom:10px;">
                        <br><br>
                          ...
                          <div class="form-group" readonly>
                              <div class="col-xs-10">
                                  <label for = "edit_req_id">Requirement ID: <span id ="changing_id"></span></label>
                              </div>
                          </div>

                          <div class="form-group">
                            <div class="col-xs-10">
                                <label for = "edit_req_name">
                                  * Requirement Name
                                </label>
                                <input type='text' maxlength='70' id = "edit_req_name" class = "form-control" placeholder = "Enter Requirement Name" required>
                            </div>
                          </div>
...
<div id="add_req" class="modal fade" role="dialog">
  <div class="modal-dialog">

    <!-- Modal content-->
    <div class="modal-content">
          <form class="form-horizontal" role="form" action = "" method = "POST" enctype="multipart/form-data" id = "form_add_req">
               
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h2 class="modal-title">&nbsp; <span class="fa fa-fw fa-paste" style="margin-right:10px;"></span>Add New Requirement </h2>
                    </div>
                    <div class="modal-body">
                        <div style = "margin-left:10%;margin-bottom:10px;">
                            <br><br>
                              ...
                              <div class="form-group" readonly>
                                  <div class="col-xs-10">
                                      <label for = "new_req_id" style='font-size:15px;'>
                                        Requirement ID: 
                                      </label>

                                          <?php
                                            $sql_in= mysql_query("Select * from requirement");
                              ...
                              <div class="form-group">
                                <div class="col-xs-10">
                                    <label for = "new_req_name">
                                      * Requirement Name
                                    </label>
                                    <input type='text' maxlength='70' id = "new_req_name" class = "form-control" placeholder = "Enter Requirement Name" required>
                                </div>
                              </div>
