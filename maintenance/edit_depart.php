...
<?php
	...
	if((isset($_POST['id']) and isset($_POST['busid'])) and isset($_POST['deptname'])){
    ...
    if($row >= 1){
        ...
        $query1 = mysql_query("Update `department` Set Name = '$deptName', BusinessNatureID = $busId WHERE DepartmentID = $deptId;");
        ?>
          <div>
              <script>
                  $(function(){
                                        ...
                                        ?>
                                            <div>
                                                <script>
                                                  $(function(){
                                                      $(document).ready(function(){
                                                        $('input[name=edit_checkbox_<?php echo $deptID;?>]').bootstrapSwitch('state', true, true);
                                                      });
                                                  });
                                                </script>
                                            </div>
...
<tr>
                                          ...
                                          <td>
                                             <center>
                                              ...
                                              ?>
                                              <?php 
                                                  echo "<input id='switch-state' name='edit_checkbox_$deptID' type='checkbox' value='$deptID' >";
                                              ?>
                                               <?php 
