...
<?php
	...
	if (isset($_POST['id'])){
		...
		$query1 = mysql_query("Update `valid_reason` Set Status = 3 WHERE ReasonID = $reasonId;");
            if ($query1 == FALSE){
                                                ...
                                                <script>
                                                  $(function(){
                                                      $(document).ready(function(){
                                                        $('input[name=delete_checkbox_<?php echo $reasonID;?>]').bootstrapSwitch('state', true, true);
                                                      });
                                                  });
                                                </script>
                                            </div>
...
<tr>
                                          ...
                                          <td>
                                             <center>
                                              ...
                                              ?>
                                              <?php 
                                                  echo "<input id='switch-state' name='delete_checkbox_$reasonID' type='checkbox' value='$reasonID' >";
                                              ?>
                                               <?php 
